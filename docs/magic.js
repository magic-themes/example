...
var Link = function Link(_ref10, children) {
  var to = _ref10.to,
      p = _objectWithoutProperties(_ref10, ["to"]);
...
var Page = function Page(_ref11, children) {
...
var Pre = function Pre(props, str) {
  ...
  var _props = props,
      ...
      lines = _props$lines === void 0 ? true : _props$lines;
  var classes = {
    Pre: true,
    lines: lines
  };
...
var Route = function Route(_ref12) {
...
var lib = {
  db: function () {
    ...
    var set = function set(dispatch, _ref13) {
    ...
    var get = function get(dispatch, _ref14) {
    ...
    var del = function del(dispatch, _ref15) {
...
var actions = {
  ...
  'gdpr': {
    ...
    'toggleAllow': function toggleAllow(state, _ref16) {
  ...
  'pre': {
    'clip': function clip(state, _ref17) {
...
var pages = {
  '/docs/': function docs(state) {
    return div([h1('@magic-themes/docs'), p(['this is the ', Link({
      to: 'https://github.com/magic-themes'
    }, '@magic-themes'), ' docs theme. It is being used as the documentation theme for most @magic packages.']), h3({
      id: 'installation'
    }, 'installation'), Pre("npm install magic-themes/docs"), h2({
      id: 'usage'
    }, 'usage'), h3({
      id: 'usage-require'
    }, 'require in config.js:'), Pre("\n// config.mjs\n\nexport default {\n  // ... other config\n  THEME: 'docs',\n}"), h3({
      id: 'usage-customize'
    }, 'customize / overwrite'), p('you can customize and add any kind of style'), p('create /assets/themes/docs/index.js, any css there will overwrite the theme css'), Pre("\n// /assets/themes/docs/index.mjs\n\nexport default {\n  body: {\n    color: 'orange',\n  },\n}"), p('magic will then find and merge the themes automatically, just as it did on this page')]);
  },
  '/docs/404/': function docs404() {
